...
from dairymaster.views import daily_milk_details_add ,DairyMasterGetAll,GetAllReportsCardView,GetOneDetailByIdView,DairyMasterGetByManyDate,daily_milk_details_update_delete,DailyMilkDetailGetById,DairyMasterUpdateView,daily_milk_details_get_by_month, MonthlyReportView

urlpatterns = [
    path('daily-milk-details-add/', daily_milk_details_add, name='daily_milk_details_add'),
    path('get-all',DairyMasterGetAll.as_view(), name='get_all'),
